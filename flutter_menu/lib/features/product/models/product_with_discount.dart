...
class ProductWithDiscount extends Equatable implements ModifierItem {
  const ProductWithDiscount(
      {required this.product, required this.discountPercentage, required this.availableWeekdays});
  ...
  static ProductWithDiscount? fromJson(Map<String, dynamic> json) {
    try {
      return ProductWithDiscount(
        ...
        availableWeekdays: json['availableWeekdays']['data'].map<Weekday>((w) => Weekday.fromMap(w)).toList()
      );
    } catch (e) {
      return null;
    }
